...
<form  name= "deliveryman_reg" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" onsubmit="return validateForm()">  
...
function validateForm() {
  var x = document.forms["deliveryman_reg"]["name"].value;
  var x = document.forms["deliveryman_reg"]["email"].value;
  var x = document.forms["deliveryman_reg"]["phone"].value;
  var x = document.forms["deliveryman_reg"]["date"].value;
  var x = document.forms["deliveryman_reg"]["address"].value;
  var x = document.forms["deliveryman_reg"]["vehicle"].value;
